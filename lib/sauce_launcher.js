...
function processConfig(helper, config, args) {
    ...
    //handle parentTunnel
    var parentTunnel = args.parentTunnel || ''
    var tunnelIdentifier = args.tunnelIdentifier || ''
    ...
    var options = helper.merge(config.options, defaults, {
...
var SauceLauncher = function (args, sauceConnect, config, logger, helper, baseLauncherDecorator, captureTimeoutLauncherDecorator, retryLauncherDecorator, jobMapping) {
    var self = this
